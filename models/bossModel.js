...
const { computeRemaining, computeAttendanceRate } = require('../utils/calculations');
...
async function getPaymentSummary(connectionId) {
  ...
  return { required, confirmed, pending, remaining: computeRemaining(required, confirmed), terms };
}
